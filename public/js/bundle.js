...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWhkYXpsYW5hYmF6aXoiLCJhIjoiY2trb2lhNG11Mmx0ZTJ2bGF3d3gzZ3JpdCJ9.5JqiLPMzNJTgfpaMVt8dsA';
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div clas=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            console.log("hi ".concat(email, " & ").concat(password));
            console.log(res);
...
var loginForm = document.querySelector('.login-form'); // VALUES
// DELEGATION
